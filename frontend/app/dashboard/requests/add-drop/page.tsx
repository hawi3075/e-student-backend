...
const AddDropRequestPage: React.FC = () => {
    ...
    const AddCourseForm = () => {
        ...
        // Check if the course is full and cannot be normally added
    ...
    return (
        <div className="space-y-8 max-w-5xl mx-auto">
            ...
            <div className="text-center text-sm text-gray-500 pt-4">
                <p className="text-xs text-gray-400">© 2025  All Rights Reserved. Reproduction or distribution of this document is prohibited without written permission.</p>
            </div>
